...
for key in traffic_level:
    ...
    for population in population_size:
        ...
        try:
            mean_data_1 = consolidate_results(Network.DEFAULT.dir_output_csv, csv_filename)
        except FileNotFoundError:
            mean_data_1 = []
        finally:
    ...
    for alg in algorithms:
        ...
        try:
            mean_data_o = consolidate_results(Network.DEFAULT.dir_output_csv, other_csv_filename)
            if alg is 'SIWPSO':
