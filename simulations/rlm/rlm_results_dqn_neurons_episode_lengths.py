...
filename_0 = "rlm_dqn_episode_lengths_{}_{}.csv".format(user_density, id_)
...
filename_1 = "rlm_dqn_episode_lengths_{}_{}.csv".format(user_density, id_)
...
filename_3 = "rlm_dqn_episode_lengths_{}_{}.csv".format(user_density, id_)
...
image_path = os.path.join(GlobalConfig.DEFAULT.rlm_path, "images", "{}_neurons_episode_lengths.eps".format(user_density))
get_training_steps_curve(data, image_path, xlabel="Episodes", ylabel="Smoothing Training Steps")
